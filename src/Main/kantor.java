 ...
 * @author Axel
 */
public class kantor extends javax.swing.JPanel {
 String sql;
   Statement stat;
   ResultSet res;
    ...
    public void show (){
        try {
            ...
            while (res.next()) {
                ...
                obj[0] = res.getString("id_kantor");
                 obj[1] = res.getString("nm_wilayah");
   ...
   tr.setRowFilter(RowFilter.regexFilter(search.getText().trim()));
    ...
    public void insert(){
        try {
            stat=cn.login().createStatement();
            sql=" INSERT INTO kantor (id_kantor, nm_wilayah)"+"VALUES ('"+idkant.getText()+"', '"+nama.getText()+"')";
            stat.execute(sql);
            bersihtabel();
    ...
    public void delete(){
        ...
        try {
               stat=cn.login().createStatement();
               sql="DELETE FROM kantor WHERE id_kantor= '"+idkant.getText()+"'";
    ...
    public void update(){
        ...
        try {
             stat=cn.login().createStatement();
          sql="SELECT id_kantor from kantor WHERE id_kantor='"+id1+"'";
          ra = stat.executeQuery(sql);
            while (ra.next()) {
               String id= ra.getString("id_kantor");
                  sql="UPDATE kantor SET id_kantor ='"+idkant.getText()+"', nm_wilayah='"+nama.getText()+"' WHERE id_kantor='"+id+"' ";  
            } stat.executeUpdate(sql);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(mainpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 793, javax.swing.GroupLayout.PREFERRED_SIZE)
...
show();// TODO add your handling code here:
    ...
    private void TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMousePressed
        ...
        DefaultTableModel model = (DefaultTableModel)Table.getModel();
        idkant.setText(model.getValueAt(selectRow,0).toString());

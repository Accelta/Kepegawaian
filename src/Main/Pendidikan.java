 ...
 * @author Axel
 */
public class Pendidikan extends javax.swing.JPanel {
 String sql;
   Statement stat;
   ResultSet res;
    ...
    public void show (){
        try {
            ...
            while (res.next()) {
              ...
              obj[0] = res.getString("id_pdk");
                 obj[1] = res.getString("id_pgw");
                 obj[2] = res.getString("t_pdk");
                 obj[3] = res.getString("d_pdk");
 ...
 public void idpgw(){
    ...
    public void insert(){
        try {
            stat=cn.login().createStatement();
            sql=" INSERT INTO pendidikan (id_pgw, t_pdk, d_pdk)"+"VALUES ( '"+idpgw.getSelectedItem()+"', '"+tpdk.getText()+"', '"+dpdk.getText()+"')";
            stat.execute(sql);
            bersihtabel();
    ...
    public void delete(){
        ...
        if (opt==0) {
             try {
               stat=cn.login().createStatement();
               sql="DELETE FROM pendidikan WHERE id_pdk= '"+test.getText()+"'";
    ...
    public void update(){
        ...
        try {
             stat=cn.login().createStatement();
          sql="SELECT id_pdk from pendidikan WHERE id_pdk='"+id1+"'";
          ra = stat.executeQuery(sql);
            while (ra.next()) {
               String id= ra.getString("id_pdk");
                  sql="UPDATE pendidikan SET  id_pgw='"+idpgw.getSelectedItem()+"', t_pdk ='"+tpdk.getText()+"', d_pdk ='"+dpdk.getText()+"' WHERE id_pdk='"+id+"' ";  
            } stat.executeUpdate(sql);
    ...
    private void initComponents() {
        ...
        tpdk = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        dpdk = new javax.swing.JTextField();
        ...
        jLabel1.setText("LIST PENDIDIKAN");
                        ...
                        .addGroup(mainpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainpanelLayout.createSequentialGroup()
                                ...
                                .addGroup(mainpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tpdk, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                                    .addComponent(dpdk)))
                            .addGroup(mainpanelLayout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addGap(18, 18, 18)
                                .addComponent(idpgw, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(mainpanelLayout.createSequentialGroup()
                        .addGap(215, 215, 215)
                        .addComponent(insert)
                        .addGap(18, 18, 18)
        ...
        mainpanelLayout.setVerticalGroup(
            ...
            .addGroup(mainpanelLayout.createSequentialGroup()
                ...
                .addGroup(mainpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(tpdk, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                .addGroup(mainpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(dpdk, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
...
show();// TODO add your handling code here:
    ...
    private void TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMousePressed
        ...
        tpdk.setText(model.getValueAt(selectRow,2).toString());
        dpdk.setText(model.getValueAt(selectRow,3).toString());
    ...
    private javax.swing.JTextField dpdk;
    ...
    private javax.swing.JTextField tpdk;
